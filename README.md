...
- [x] [Building a Non-blocking TCP server using OTP principles](https://saleyn.github.io/erlang/non-blocking-tcp-server.html) by Serge Aleynikov
- [x] [Gen event behavior demystified](https://saleyn.github.io/erlang/gen-event-demystified.html) by Serge Aleynikov
- [x] [Using EI interface in port programs](https://saleyn.github.io/erlang/ei-in-port-programs.html) by Serge Aleynikov
- [x] [SNMP Quick Start](https://saleyn.github.io/erlang/snmp-quick-start.html) by Vance Shipley and Serge Aleynikov
...
- [x] [Programming Erlang: Software for a Concurrent World by Joe Armstrong (2nd edition)](http://www.amazon.com/Programming-Erlang-Software-Concurrent-World/dp/193778553X/ref=pd_sim_sbs_b_9)
...
- [x] [Execute and control OS processes from Erlang/OTP](https://github.com/saleyn/erlexec)
- [x] [MapReduce and Pipeline Parse Transforms for Erlang](https://github.com/saleyn/etran)
- [x] [Direct access to memory mapped files and memory sharing in Erlang](https://github.com/saleyn/emmap)
- [x] [Miscellaneous utility modules for Erlang](https://github.com/saleyn/util)
- [x] [Network Protocol Abstraction for Erlang](https://github.com/saleyn/proto)
- [x] [Direct support of external Erlang term binary format in Javascript](https://github.com/saleyn/erlb.js)
- [x] [Network Monitor for detecting network splits](https://github.com/saleyn/netmon)
- [x] [Gen_timed supervisor behaviour of scheduled task execution](https://github.com/saleyn/gen_timed_server)
